"""Code used for inference for CLMR model.
Source (slightly modified for inference purposes):
    https://github.com/Spijkervet/CLMR, Apache License 2.0
"""
...
class SampleCNN(Model):
    def __init__(self, strides, supervised=False):
